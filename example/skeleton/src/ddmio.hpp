...
// Copyright (C) 2005--2012 N.Yu.Zolotykh
...
#define WRITEOUTPUTA(msg, a)           \
  ...
  {                                    \
    std::cout << msg;                  \
    matrix_output(std::cout, a, matrixoutputformat);       \
  }                                    \
  if (outputfileflag)                  \
  {                                    \
    outputfile << msg;                 \
    matrix_output(outputfile, a, matrixoutputformat);      \
  }
...
// MATRIXOUTPUTFORMATCOLUMN 1
// MATRIXOUTPUTFORMATEQUAL  2
