...
int main(int argc, char *argv[])
{
    ...
    file_name_result += std::to_string(source_dimension + 1) + "d_f_max" + std::to_string(max_facet) + "_v" + std::to_string(count_vertex) + ".txt";
    std::string file_name_time = "full_time";
    file_name_time += std::to_string(source_dimension + 1) + "d_f_max" + std::to_string(max_facet) + "_v" + std::to_string(count_vertex) + ".txt";
